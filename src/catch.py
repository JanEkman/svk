...
"""
   ...
   parameter settings controlling the detection of faults, which are 
   of three kinds: for anomaly detection, for classification and for
   determining the condition under which the anomaly was found

"""
n1    = 20     # size of predessor batch for finding anomalies
n2    = 1      # size of successor batch for finding anomalies
start = 50     # the number of samples in the start to ignore
p     = 1e-7   # anomaly probability level, for deciding on if there is an anomaly
eps   = 1e-20  # offset added to normality for plotting the neglog of it
w     = 30     # for classification: width of the analysed parts around the anomalies
gap   = 10     # for classification: the gap on each side of the alarm not analysed
stdlim= 0.05   # for condition determination: battch std limit for unstable situation
spike = 3.5    # for condition determination: point std limit for noise
